...
export function Contact() {
  ...
  const sendEmail = async (e) => {
    ...
    try {
      await emailjs.sendForm("service_ncqs3hl", "template_5lmwj0u", form.current, "z42E71FN1v8cabK5c")
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-4 sm:p-6 md:p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Link href="mailto:vuelosdebautismos@gmail.com" className="hover:underline text-muted-foreground">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Link
                    href="https://www.instagram.com/vuelosdebautismo.bs.as/"
                    target="_blank"
                    className="hover:underline text-muted-foreground"
                  >
          ...
          <div className="mt-8">
            ...
            <p className="text-muted-foreground mb-4">500 Av. Figueroa Alcorta, Moron.</p>
            <Map />
          </div>
        </div>
      </div>
...
function Map() {
  return (
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d820.4286226647496!2d-58.64310113032706!3d-34.66191269521972!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcc7527bbb5a65%3A0x9fe7f7f6b8275e14!2sAv.%20Figueroa%20Alcorta%20500%2C%20B1712%20Castelar%2C%20Provincia%20de%20Buenos%20Aires!5e0!3m2!1ses!2sar!4v1731070769444!5m2!1ses!2sar"
